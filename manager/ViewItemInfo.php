...
<!-- URL: http://localhost/4523m-project/manager/ViewItemInfo.php-->
<!-- URL: http://localhost/4523m-project/manager/ViewItemInfo.php... -->
...
<head>
    ...
    <title>Better Limited - Item List</title>
            ...
            <div class="main-panel">
                <nav class="navbar navbar-light navbar-expand-md">
                    <div class="container-fluid">
                        <div><a class="navbar-brand" href="#">Item Information List</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button></div>
            ...
            if ($num == 0){
                ...
                <!-- get the Item Information List records -->
                        ...
                        while ($rec = mysqli_fetch_assoc($rs)) {
                            echo <<<EOF
                                <tr>
                                    <td style="width: 40px;text-align: center;"><input type="checkbox" style="width: 20.8px;"></td>
                                    <td>{$rec['itemID']}</td>
                                    <td>{$rec['itemName']}</td>
